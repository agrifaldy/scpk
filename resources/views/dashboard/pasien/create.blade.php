    ...
    <div class="container-fluid">
        <form action="{{route('dashboard.pasien.store')}}" method="post" class="was-validated" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="umur" placeholder="Masukan Nomor" name="umur" required>
                <div class="valid-feedback"></div>
                <div class="invalid-feedback">Harap diisi</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="kota" placeholder="Masukan Nama" name="kota" required>
                <div class="valid-feedback"></div>
                <div class="invalid-feedback">Harap diisi</div>
            </div>
            <div class="form-group">
